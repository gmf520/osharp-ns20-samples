...
{
    public class DesignTimeMySqlDbContextFactory : DesignTimeDbContextFactoryBase<MySqlDbContext>
    {
        public DesignTimeMySqlDbContextFactory()
            : base(null)
        { }

        public DesignTimeMySqlDbContextFactory(IServiceProvider serviceProvider)
